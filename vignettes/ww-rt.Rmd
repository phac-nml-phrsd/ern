...
Once the above items are loaded, $R_t$ can be estimated using `estimate_R_ww()`. In this example, the number of iterations will be set to 20 (the default is 100). Output messages are defaulted as `TRUE`; but in this example they will be suppressed.
